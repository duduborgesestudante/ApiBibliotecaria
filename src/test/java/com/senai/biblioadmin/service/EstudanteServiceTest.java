...
//        List<Estudante> listaEstud = estudanteService.listarEstudantes(int pagina);
...
//        Estudante estud = listEstudante.get(0);;
...
//        estud.setTelefone(listEstudante.get(0).getTelefone());
...
//        Boolean result = estudanteService.alterarEstudante(estud);
//        Boolean resultEsperado = false;
//        assertNotEquals(result,resultEsperado,"#14 Erro: Foi alterado Estudante com matricula cadastrada");   
//    }
//    @Test
//    @Transactional
//    @Order(15)
...
//        assertEquals(result,resultEsperado,"#16 Erro: Foi alterado Estudante sem telefone");   
//    }
//    @Test
//    @Transactional
//    @Order(17)
...
//        Boolean result = estudanteService.alterarEstudante(estud);
//        Boolean resultEsperado = false;
//        assertNotEquals(result,resultEsperado,"#16 Erro: Foi alterado Estudante sem senha");   
//    }
//
////    
////
